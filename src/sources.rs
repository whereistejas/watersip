...
impl Source for AmazonSellerPartner {
    const IMAGE: &'static str = "airbyte/source-amazon-seller-partner:0.2.0";
...
impl Source for Asana {
    const IMAGE: &'static str = "airbyte/source-asana:0.1.3";
    fn specs(&self) -> serde_json::Value {
...
impl Source for Chargebee {
    const IMAGE: &'static str = "airbyte/source-chargebee:0.1.4";
    fn specs(&self) -> serde_json::Value {
...
impl Source for ExchangeRatesApi {
    const IMAGE: &'static str = "airbyte/source-exchange-rates:0.2.3";
    fn specs(&self) -> serde_json::Value {
...
impl Source for File {
    const IMAGE: &'static str = "airbyte/source-file:0.2.6";
    fn specs(&self) -> serde_json::Value {
